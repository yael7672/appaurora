...
@Component({
  selector: 'app-my-service-call',
  templateUrl: './my-service-call.component.html',
  styleUrls: ['./my-service-call.component.css']
})
export class MyServiceCallComponent implements OnInit {
  isManager:boolean=false;
  callings:Calling[]=[];
  listIncident : IncidentsArray= new IncidentsArray(this.callings);
  userId:ContactGuid=new ContactGuid("c3371126-f0e1-ea11-a813-000d3a3a10cd");
  ...
  ngOnInit(): void {
    ...
    {this.isManager=true;}
   let userId1 =localStorage.getItem("user")

  this.userService.getCalling(this.userId).subscribe((t:IncidentsArray)=>
  {this.listIncident=t;
    this.incidentService.listIncident=t;
...
{
// this.userService.getEventById(id).subscribe((s:Incident)=>{
